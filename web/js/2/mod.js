...
ChiptuneJsPlayer.prototype.clearHandler = function () {
	this.handlers=[];
}
...
ChiptuneJsPlayer.prototype.duration = function() {
	if(!this.currentPlayingNode || !this.currentPlayingNode.modulePtr)return;
...
ChiptuneJsPlayer.prototype.setVolume = function(value) {	
	if(this.gainNode){
...
ChiptuneJsPlayer.prototype.paused = function() {
	if (this.currentPlayingNode != null) {
...
ChiptuneJsPlayer.prototype.createLibopenmptNode = function(buffer, config) {
  ...
  /*if(processNode.modulePtr==0){
	  console.log(processNode.modulePtr);
